...
def seed_follower():
    ...
    insert_stmnt2 = follows.insert().values(followerId=4, followedId=1)
    ...
    insert_stmnt5 = follows.insert().values(followerId=3, followedId=1)
    insert_stmnt6 = follows.insert().values(followerId=3, followedId=7)
    insert_stmnt7 = follows.insert().values(followerId=6, followedId=1)
